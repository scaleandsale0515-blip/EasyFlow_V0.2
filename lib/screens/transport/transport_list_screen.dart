            ...
            children: [
              ...
              Padding(
                ...
                child: SegmentedButton<_GroupMode>(
                  segments: const [
                    ButtonSegment(value: _GroupMode.byDate, icon: Icon(Icons.calendar_today_outlined, size: 16), label: Text('By Date')),
                    ButtonSegment(value: _GroupMode.byTransporter, icon: Icon(Icons.local_shipping_outlined, size: 16), label: Text('By Transporter')),
                  ],
                  selected: {_mode},
